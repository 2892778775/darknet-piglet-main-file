...
char *voc_names[] = {"pig-ear"};

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/timen/darknet/scripts/2017_train.txt";
...
void validate_yolo(char *cfg, char *weights)
{
    ...
    list *plist = get_paths("/home/timen/darknet/scripts/2017_val.txt");
...
void validate_yolo_recall(char *cfg, char *weights)
{
    ...
    char *base = "results/test_output_";
    list *plist = get_paths("scrpts/2017_val.txt");
    char **paths = (char **)list_to_array(plist);
