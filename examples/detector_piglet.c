...
void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    char *train_images = option_find_str(options, "train", "scripts/2008_train.txt");
...
void validate_detector_flip(char *datacfg, char *cfgfile, char *weightfile, char *outfile)
{
    int j;
    list *options = read_data_cfg(datacfg);
    char *valid_images = option_find_str(options, "valid", "scripts/2008_val.txt");
    ...
    if(0==strcmp(type, "coco")){
        ...
        if(!outfile) outfile = "whole_test_";
...
void validate_detector_recall(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("scripts/2008_val.txt");
    char **paths = (char **)list_to_array(plist);
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        if(outfile){
            ...
            //show_image(im, "predictions", 0); timen change
...
void run_detector(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], "test")) test_detector(datacfg, cfg, weights, filename, thresh, hier_thresh, outfile, fullscreen);
        ...
        list *options = read_data_cfg(datacfg);
        int classes = option_find_int(options, "classes", 6);
        char *name_list = option_find_str(options, "names", "data/names.list");
        char **names = get_labels(name_list);
