...
void validate_detector_recall(char *datacfg,char *cfgfile, char *weightfile)
{
    ...
    //list *plist = get_paths("/home/timen/darknet/scripts/test_600.txt");
    //char **paths = (char **)list_to_array(plist);
    list *options = read_data_cfg(datacfg);
    char *valid_images = option_find_str(options, "valid", "scripts/piglet_val.txt");
    list *plist = get_paths(valid_images);
    char **paths = (char **)list_to_array(plist);
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        if(filename){
            ...
            int m = plist->size;
            if(access("/home/timen/darknet/data/postures_prediction",0)==-1)
            {
              if (mkdir("/home/timen/darknet/data/postures_prediction",0777))
               {
            ...
            for(i = 0; i < m; ++i){
                ...
                if(outfile){
                    ...
                    char b[2048];
                    sprintf(b,"/home/timen/darknet/data/postures_prediction/%s",GetFilename(path));
